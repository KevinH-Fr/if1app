...
scope :compte_p6, -> { where("(course) = 1").count}
scope :compte_p7, -> { where("(course) = 2").count}
scope :compte_p8, -> { where("(course) = 3").count}
scope :compte_p9, -> { where("(course) = 4").count}
scope :compte_p10, -> { where("(course) = 5").count}
scope :compte_p11, -> { where("(course) = 1").count}
scope :compte_p12, -> { where("(course) = 2").count}
scope :compte_p13, -> { where("(course) = 3").count}
scope :compte_p14, -> { where("(course) = 4").count}
scope :compte_p15, -> { where("(course) = 5").count}
scope :compte_p16, -> { where("(course) = 1").count}
scope :compte_p17, -> { where("(course) = 2").count}
scope :compte_p18, -> { where("(course) = 3").count}
scope :compte_p19, -> { where("(course) = 4").count}
scope :compte_p20, -> { where("(course) = 5").count}
# continuer ajouter les autres compte p x


scope :order_score_positions, 
      -> {order(score: :DESC, compte_p1: :DESC, compte_p2: :DESC, compte_p3: :DESC, compte_p4: :DESC, compte_p5: :DESC,
