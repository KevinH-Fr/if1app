class Pariquart < ApplicationRecord
...
#  validate :verif_montant
  ...
  def verif_montant
    ...
    soldeParieurAvant = Pariquart.saison_courant(saisonId).division_courant(divisionId).numero_until_courant(eventNum).pilote_courant(self.parieur_id).sum_parieur.first.total
